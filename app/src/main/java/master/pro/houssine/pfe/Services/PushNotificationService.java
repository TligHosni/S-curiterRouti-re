...
//        }
    ...
    private RemoteViews getCustomDesign(String title,
        ...
        remoteViews.setTextViewText(R.id.notif_details, message);
    ...
    public void showNotification(String title, String message) {
        ...
        Intent intent = new Intent(this, Maps_Citoyen.class);
        // Assign channel ID
...
//        dialog.setContentView(R.layout.confirme_declaration);
